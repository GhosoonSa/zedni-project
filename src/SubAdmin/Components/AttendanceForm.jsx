...
const AttendanceForm = ({ subjectId, onSubmit }) => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    onSubmit(date, presentStudentIds, subjectId);
    setSubmitted(true);
            ...
            <Grid item xs={12} sm={6} md={4} lg={3} key={student.studentID}>
              <ListItem
                sx={{
                  p: 1,
                  direction: "rtl",
                  backgroundColor: attendance[student.studentID]
                    ? "rgba(231, 188, 145, 0.2)"
                    : "transparent",
                  borderRadius: 1,
                  border: "1px solid #e0d6c2",
                  display: "flex",
              ...
              >
                ...
                >
                  ...
                  <ListItemText
                    primary={student.firstAndLastName}
                ...
                <FormControlLabel
                  control={
                    <Checkbox
                      checked={presentStudentIds.includes(student.studentID)}
