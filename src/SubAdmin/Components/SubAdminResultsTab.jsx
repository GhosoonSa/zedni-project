...
const SubAdminResultsTab = () => {
  ...
  const initialMarks = {
    study: { 1: 25, 2: 28, 3: 20, 4: 30, 5: 3 },    // علامات المذاكرة (من 30)
    exam: { 1: 40, 2: 45, 3: 35, 4: 50, 5: 2 },     // علامات الامتحان (من 50)
    attendance: { 1: 15, 2: 18, 3: 12, 4: 20, 5: 10 }, // علامات الحضور (من 20)
    total: { 1: 44, 2: 33, 3: 47, 4: 100, 5: 40 },    // المجموع الكلي (من 100)
    status: { 1: "راسب", 2: "راسب", 3: "راسب", 4: "ناجح", 5: "راسب" } // النتيجة
  };
