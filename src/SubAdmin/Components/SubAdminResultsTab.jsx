...
const SubAdminResultsTab = ({ courseId, level }) => {
  ...
  const handleMarkChange = (studentId, value) => {
    ...
    const numValue =
      value === ""
        ? ""
        : Math.min(maxValue, Math.max(0, parseFloat(value) || 0));
    ...
    >
      <Button
        ...
        sx={{
          ...
          "&:hover": {
            backgroundColor:
              activeView === "study" ? "#7b3f00" : "rgba(90, 62, 27, 0.1)",
          },
        }}
      >
      ...
      <Button
        ...
        sx={{
          ...
          "&:hover": {
            backgroundColor:
              activeView === "exam" ? "#7b3f00" : "rgba(90, 62, 27, 0.1)",
          },
        }}
      >
      ...
      <Button
        ...
        sx={{
          ...
          "&:hover": {
            backgroundColor:
              activeView === "results" ? "#7b3f00" : "rgba(90, 62, 27, 0.1)",
          },
        }}
      >
        عرض النتائج
  ...
  const renderMarksEntry = () => {
    ...
    const label =
      activeView === "study"
        ? `علامة المذاكرة (${maxValue})`
        : `علامة الامتحان (${maxValue})`;
